...
export const mockInquiryTemplates: InquiryTemplate[] = [
  {
    ...
    steps: [
      { verificationType: "government_id", required: true },
      { verificationType: "selfie", required: true },
      { verificationType: "database", required: false },
    ],
    settings: {
      autoApprove: false,
      expiresInDays: 30,
  ...
  },
  {
    ...
    steps: [
      { verificationType: "government_id", required: true },
      { verificationType: "document", required: true },
      { verificationType: "selfie", required: true },
      { verificationType: "database", required: true },
    ],
    settings: {
      autoApprove: false,
      expiresInDays: 7,
  ...
  },
  {
    ...
    steps: [{ verificationType: "selfie", required: true }],
    settings: {
      autoApprove: true,
      expiresInDays: 3,
      maxRetries: 2,
  ...
  },
  {
    ...
    steps: [
      { verificationType: "document", required: true },
      { verificationType: "selfie", required: false },
    ],
    settings: {
      autoApprove: false,
      expiresInDays: 21,
  ...
  },
  {
    ...
    steps: [{ verificationType: "document", required: true }],
    settings: {
      autoApprove: true,
      expiresInDays: 2,
      maxRetries: 1,
  ...
  },
  {
    ...
    steps: [
      { verificationType: "selfie", required: true },
      { verificationType: "government_id", required: false },
    ],
    settings: {
      autoApprove: false,
      expiresInDays: 5,
  ...
  },
  {
    ...
    steps: [
      ...
      { verificationType: "selfie", required: true },
      { verificationType: "database", required: true },
      { verificationType: "document", required: false },
    ],
    settings: {
      autoApprove: false,
      expiresInDays: 10,
